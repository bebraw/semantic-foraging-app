...
const catalog: CatalogCandidate[] = [
  ...
  },
  {
    ...
    species: ["chanterelle", "trumpet", "mushroom"],
    habitat: ["spruce", "mossy", "wet"],
    region: ["helsinki", "uusimaa"],
    season: ["autumn"],
    evidence: [],
  ...
  },
  {
    ...
    species: ["chanterelle", "morel", "mushroom"],
  ...
  },
  {
    ...
    summary: "Low spruce shade and damp shoreline moss point to a compact bilberry patch near inland water.",
    statusLabel: "Observation lead",
    species: ["bilberry", "berry"],
    habitat: ["spruce", "mossy", "lakeside"],
  ...
  {
    id: "patch-lingonberry-heath-rim",
    kind: "patch",
    title: "Lingonberry heath rim",
    summary: "A pine heath edge with repeated lingonberry signals and easy shoreline access.",
    statusLabel: "Patch candidate",
    species: ["lingonberry", "berry"],
    habitat: ["pine", "heath", "lakeside"],
    region: ["lake district", "finland"],
    season: ["autumn"],
    evidence: [],
    spatialContext: {
  ...
  {
    id: "trail-blueberry-ridge-loop",
    kind: "trail",
    title: "Blueberry ridge loop",
    summary: "A short ridge loop linking mature spruce cover and productive late-summer blueberry ground.",
    statusLabel: "Trail fragment",
    species: ["blueberry", "bilberry", "berry"],
    habitat: ["spruce", "ridge", "mossy"],
    region: ["lake district", "finland"],
    season: ["summer"],
    evidence: [],
    spatialContext: {
  ...
  },
  {
    ...
    summary: "A broad yellow chanterelle signal sits above the lakeshore in damp spruce with moss underfoot.",
    statusLabel: "Observation cluster",
    species: ["chanterelle", "mushroom"],
  ...
  {
    id: "patch-lake-district-trumpet-slope",
    kind: "patch",
    title: "Trumpet slope above the waterline",
    summary: "A dark mossy slope with concentrated trumpet signals near the lake district shoreline.",
    statusLabel: "Patch candidate",
    species: ["trumpet", "mushroom"],
    habitat: ["spruce", "mossy", "lakeside"],
    region: ["lake district", "finland"],
    season: ["autumn"],
    evidence: [],
  ...
  },
  {
    ...
    summary: "A pine-to-birch transition route with repeated porcini notes across the lake district.",
    statusLabel: "Trail fragment",
    species: ["porcini", "boletus", "mushroom"],
  ...
  switch (submission.classification.intent) {
    case "find-observations":
      return combineCandidateSources(
        ...
        selectCatalogCards(submission, ["observation", "patch", "trail"], 4),
        4,
      );
    case "inspect-patch":
      return combineCandidateSources(
